...
const highlights = [
  ...
  "Close proximity to Chennai’s top schools, hospitals, shopping hubs, and transport links.",
  "Contemporary design paired with thoughtful features for an elevated lifestyle. Surrounded by lush greenery, offering a serene and refreshing environment.",
  "State-of-the-art amenities that support comfort and recreation.A welcoming community that offers a balanced lifestyle of comfort and convenience.",
];
